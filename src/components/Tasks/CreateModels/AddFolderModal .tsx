// AddFolderModal.jsx - نسخة محسنة بتصميم متطابق مع المنصة

import { useEffect } from "react";
import { X, FolderPlus, Users, Plus, Bell, Trash2, FolderOpen, UserPlus } from "lucide-react";
          ...
          <div className="relative flex items-start justify-between gap-3 sm:gap-4">
            <div className="flex min-w-0 items-center gap-2.5 sm:gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-blue-100/60 text-blue-600 ring-1 ring-blue-200/40 sm:h-11 sm:w-11 sm:rounded-xl">
                <FolderOpen className="h-4.5 w-4.5 sm:h-5 sm:w-5" />
              </div>
          ...
          <div className="grid gap-3.5 sm:gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. UI Tasks, Development, Design..."
